...
class INCAScript:
    ...
    def save_INCAScript(self, script, scriptname):
        """
    ...
    def runner_script_generator(self, output_filename, n_estimates=10, run_continuation: bool=True, run_simulation: bool=True):
        """
...
script_generator_descr = INCAScript()
"""A class to write and execute an INCA script in MATLAB.

Examples
--------
>>> from BFAIR.INCA import INCAScript
...
>>> INCAScript.save_INCAScript(script, "testscript")
Same goesfor the runner script
>>> runner = INCAScript.runner_script_generator('TestFile', 10)
>>> INCAScript.save_runner_script(runner=runner, scriptname="testscript")
